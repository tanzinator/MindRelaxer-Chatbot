...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final LanguageConfig config = new LanguageConfig("ja", "f4d213d6551444a69baac141c42028e0");
        initService(config);
    }
    ...
    public void onClick(View v) {
        ...
        if(chatView.getInputText().equals("Cheer me up")) {
            //pull interests from Dialogflow
            //find related subreddit
            //analyze Sentiment of top 10 related memes
            //display the first meme
           String url = "http://www.reddit.com/r/memes/.json";
        }
        if (chatView.getInputText().equals("tisha sing pardesi")) {
            MediaPlayer mp  = MediaPlayer.create(this, R.raw.pardesi);
            try {
                mp.start();
            }
            catch(Exception e) {
        ...
        if (chatView.getInputText().equals("tisha sing aisa geet gao")) {
            MediaPlayer mp  = MediaPlayer.create(this, R.raw.aisa_geet);
            try {
                mp.start();
            }
            catch(Exception e) {
        ...
        if (chatView.getInputText().equals("panvin")) {
            MediaPlayer mp  = MediaPlayer.create(this, R.raw.panvin);
            try {
                mp.start();
            }
            catch(Exception e) {
       ...
       //new GetUrlContentTask().execute("http://www.reddit.com/r/memes/.json");
    ...
    private class GetUrlContentTask extends AsyncTask<String, Integer, String> {
        protected String doInBackground(String... urls) {
            try {
                ...
                inferenceInterface = new TensorFlowInferenceInterface(getAssets(), "file:///android_asset/frozen_inference_graph.pb");
                inferenceInterface.feed(content, INPUT_SIZE);
